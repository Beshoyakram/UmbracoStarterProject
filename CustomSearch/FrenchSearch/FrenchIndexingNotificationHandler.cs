...
{
    public class FrenchIndexingNotificationHandler : INotificationHandler<ContentCacheRefresherNotification>
    {
        ...
        public FrenchIndexingNotificationHandler(IRuntimeState runtimeState,
            IUmbracoIndexingHandler umbracoIndexingHandler,
            IExamineManager examineManager, IContentService contentService
, FrenchIndexValueSetBuilder frenchIndexValueSetBuilder)
        {
        ...
        public void Handle(ContentCacheRefresherNotification notification)
        {
            ...
            if (!_examineManager.TryGetIndex("FrenchIndex", out IIndex? index))
            {
                throw new InvalidOperationException("Could not obtain the French index");
            }
            ...
            foreach (ContentCacheRefresher.JsonPayload payload in payloads)
            {
                         ...
                         payload.ChangeTypes.HasType(TreeChangeTypes.RefreshBranch))
                {
                    ...
                    IEnumerable<ValueSet> valueSets = _frenchIndexValueSetBuilder.GetValueSets(content);
